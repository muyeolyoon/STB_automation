    ...
    def save_filtered_logs(self):
        ...
        with open(self.output_path, 'w', encoding='utf-8') as outfile:
            process = subprocess.Popen(
                ["adb", "-s", Setting.device_ip, "logcat", "-v", "time"],
...
class PostAdAction:
    ...
    def _verify_channel_switch(device_ip: str, timeout: int = 15):
        proc = subprocess.Popen(
            [Setting.adb_path, "-s", device_ip, "logcat", "-v", "time"],
    ...
    def execute(device_ip, action_type="default"):
        ...
        action_map = {
            "default": [(24, "음량 up"), (25, "음량 down"), (164, "음소거"), (23, "확인"), (66, "확인"), (82, "옵션")] + [(20, "down")] * 6 + [(66, "확인"), (4, "이전"), (4, "이전")],
            "option_channel_list": [(82, "옵션"), (20, "down"), (20, "down"), (66, "확인"), (4, "이전")],
            "search": [(84, "검색"), (84, "검색"), (4, "이전")],
            "home": [(3, "홈"), (4, "이전"), (4, "이전")],
        ...
        try:
            for line in process.stdout:
                if "AdPlayItem" in line:
                    print(f"{current_time_str()} 광고 감지됨 → 액션 시작")
                    time.sleep(15)
...
def load_ad_schedule():
    ...
    rows = _load_schedule_rows(Setting.SERVICE_ACCOUNT_PATH, section="uplus")
    return [
        {
            "ad_time": row["ad_time"],
            "channel": row["channel"],
...
def main():
    ...
    recorder.start_recording()  # 녹화 시작
    print("녹화시작~")
    ...
    monitor = AdMonitor(Setting.device_ip, None, ad_schedule, action_sequence)
    monitor.start()
