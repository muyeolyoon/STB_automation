        ...
        def capture():
            with open(filtered_log_file, "w", encoding="utf-8") as f:
                proc = subprocess.Popen(
                    [SkbSetting.adb_path, "-s", device_ip, "logcat"],
...
def main():
    ...
    LogCapture.start(SkbSetting.device_ip)
    ...
    for ad in ad_schedule:
        ...
        switch_channel(channel, SkbSetting.device_ip)
        ...
        monitor = AdMonitor(SkbSetting.device_ip)
