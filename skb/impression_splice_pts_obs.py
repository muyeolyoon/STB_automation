...
def start_recording(filename):
    ...
    return subprocess.Popen(["adb", "-s", SkbSetting.device_ip, "shell", "screenrecord", f"/sdcard/{filename}"]), path
...
def stop_recording(proc, filename):
    ...
    # subprocess.run(["adb", "-s", SkbSetting.device_ip, "shell", "rm", f"/sdcard/{filename}"])
